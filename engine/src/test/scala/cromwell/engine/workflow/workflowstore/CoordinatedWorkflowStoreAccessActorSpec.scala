...
import cromwell.engine.workflow.workflowstore.CoordinatedWorkflowStoreAccessActor.{FetchStartableWorkflows, WriteHeartbeats}
...
class CoordinatedWorkflowStoreAccessActorSpec extends TestKitSuite("WorkflowStoreCoordinatedWriteActorSpec")
  ...
  it should "writeHeartBeats" in {
    ...
    val actor = TestActorRef(new CoordinatedWorkflowStoreAccessActor(workflowStore))
